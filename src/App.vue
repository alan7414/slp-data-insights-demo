...
const VIEWS = { overview: OverviewView, success: SuccessView, fraud: FraudView, balance: BalanceView, transfer: FundTransferView, security: SecurityView, notification: NotificationView };
