...
export const METRIC_MODULES = [
  ...
  },
  {
    ...
    metrics: [
      ...
      {
        name: '失败归因 · 大类分析',
        formula: '按卡交易链路顺序：① 风控拦截（SLP 3000 / Fraud Screen Declined）② 3DS 未完成（SLP 4452 / authentication_declined）③ 发卡行拒付-欺诈风险（SLP 4463 / 59）④ 持卡人账户问题（SLP 4459 过期、4467 超限、4552 账户异常）⑤ 其它（SLP 4600、4453、4466、4451 及 EXPIRED）',
        desc: '统计范围 = FAILED 92 笔（EXPIRED 15 笔归入其它并可在错误码明细中拆分）；大类口径以 SLP Error Code 为主，Channel Error Code 为渠道侧参考。',
        source: 'Payment Funnel / SLP Error Code / Channel Error Code',
        sample: '样本实测：22 / 34 / 15 / 5 / 16 = 92 笔',
      },
      {
        name: '失败归因 · 详细错误码',
